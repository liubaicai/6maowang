<template>
  ...
  >
    ...
    >
      ...
      <div 
        v-if="photo.hasS3" 
        class="absolute top-2 right-2 w-5 h-5 bg-purple-500/80 rounded-full flex items-center justify-center"
        title="已同步到 S3"
      >
        <UIcon name="i-heroicons-cloud" class="w-3 h-3 text-white" />
      </div>
    </div>
